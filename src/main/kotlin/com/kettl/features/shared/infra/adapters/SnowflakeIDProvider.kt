...
class SnowflakeIDProvider(private val nodeId: Long, private val customEpoch: Long) : IDProvider {
    ...
    fun nextId(): Snowflake {
        ...
        return Snowflake((currentTimestamp shl NODE_ID_BITS + SEQUENCE_BITS or (nodeId shl SEQUENCE_BITS)
                or sequence))
    }
    ...
    override fun generate(): Snowflake {
        return this.nextId();
    }
